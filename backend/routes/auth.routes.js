...
router.post('/register/financier', authCtrl.registerFinancier)
router.post('/register/public', authCtrl.registerPublicUser)
...
router.post('/login/public', authCtrl.loginPublicUser)
